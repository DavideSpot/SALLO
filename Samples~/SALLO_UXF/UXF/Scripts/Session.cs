...
namespace UXF
{
    ...
    public class Session : MonoBehaviour, ISettingsContainer
    {
        ...
        /// </summary>
        /// <returns></returns>
        [Tooltip("Event(s) to trigger when a block begins. Can pass the instance of the Block as a dynamic argument")]
        ...
        /// </summary>
        /// <returns></returns>
        [Tooltip("Event(s) to trigger when a block ends. Can pass the instance of the Block as a dynamic argument")]
